...
class Propagator(object):
    ...
    def basename(self):
        ...
        """
        string = "%s-%s" % (str(self.fd.params), randint(0, 100000000)) #"%s" % (str(self.fd.params)) #This implies caching. Verify whether caching works perfectly before merging to master
